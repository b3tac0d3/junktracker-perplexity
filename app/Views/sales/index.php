                ...
                <?php if (!empty($sales)): ?>
                    <?php foreach ($sales as $sale): ?>
                        ...
                        <tr data-type="<?php echo htmlspecialchars($sale['type']); ?>">
                            <td>
                                <a href="/junktracker/public/sales/<?php echo $sale['id']; ?>" class="text-primary" style="text-decoration: none;">
                            ...
                            <td>
                                <a href="/junktracker/public/sales/<?php echo $sale['id']; ?>" style="text-decoration: none; color: inherit;">
                            ...
                            <td>
                                <div style="display: flex; gap: 0.25rem;">
                                    <a href="/junktracker/public/sales/<?php echo $sale['id']; ?>" class="btn btn-sm btn-light" title="View">
                                        👁️
                                    </a>
                                    <button
